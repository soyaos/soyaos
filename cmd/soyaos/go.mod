...
require (
	github.com/soyaos/soyaos/pkg/artifact v0.1.0-alpha.2
	github.com/soyaos/soyaos/pkg/auth v0.1.0-alpha.2
	github.com/soyaos/soyaos/pkg/connectors v0.1.0-alpha.2
	github.com/soyaos/soyaos/pkg/control v0.1.0-alpha.2
	...
	github.com/soyaos/soyaos/pkg/openaicompat v0.1.0-alpha.2
